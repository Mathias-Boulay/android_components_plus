...
/** Static version of the argb evaluate function from ArgbEvaluator. */
fun evaluateArgb(fraction: Float, startValue: Any, endValue: Any): Int {
...
fun getDeviceAccentColor(context: Context) : Int {
    ...
    ctx.theme.resolveAttribute(android.R.attr.color, value, true)
    return value.data
}
